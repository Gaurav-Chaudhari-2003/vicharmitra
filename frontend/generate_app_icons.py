...
pub_dir = "/home/stark/JetBrainsProjects/vicharmitra/frontend/public"
svg_path = os.path.join(pub_dir, "vicharmitra-logo.svg")
src_512 = os.path.join(pub_dir, "vicharmitra-icon-512.png")
...
for sz in sizes:
    ...
    out_path = os.path.join(pub_dir, f"vicharmitra-icon-{sz}.png")
    resized.save(out_path, "PNG")
    print(f"Saved transparent {out_path} ({sz}x{sz})")

# Main desktop app icon & favicons
img_512 = img.resize((512, 512), Image.Resampling.LANCZOS)
img_512.save(os.path.join(pub_dir, "vicharmitra-icon.png"), "PNG")
img_512.save(os.path.join(pub_dir, "icon.png"), "PNG")
print("Saved transparent vicharmitra-icon.png and icon.png (512x512)")

app_dir = "/home/stark/JetBrainsProjects/vicharmitra/frontend/app"
