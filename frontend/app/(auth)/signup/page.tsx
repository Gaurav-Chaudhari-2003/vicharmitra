      ...
      <div className="w-full max-w-md animate-fadeIn">
        <div className="text-center mb-8">
          <div className="flex justify-center mx-auto mb-6">
            <img src="/vicharmitra-drive.svg" alt="Vicharmitra Logo" className="h-20 md:h-24 lg:h-28 w-auto object-contain drop-shadow-md" />
          </div>
          <h1 className="text-2xl font-bold text-textMain">Create Account</h1>
          <p className="text-textMuted mt-2">Get started with Vicharmitra document platform</p>
        </div>
