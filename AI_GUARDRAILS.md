...
This document describes the design, implementation, and verification of the enterprise-grade AI Guardrails built into the Vicharmitra RAG pipeline.
...
### Guardrail Module
Defined at [guardrail_service.py](file:///home/stark/JetBrainsProjects/vicharmitra/backend/app/services/guardrail_service.py):
...
### Search Handler Hook
Integrated at [search_service.py](file:///home/stark/JetBrainsProjects/vicharmitra/backend/app/services/search_service.py#L25-L39):
```python
...
```
And output validation integrated at [search_service.py](file:///home/stark/JetBrainsProjects/vicharmitra/backend/app/services/search_service.py#L202-L208):
```python
